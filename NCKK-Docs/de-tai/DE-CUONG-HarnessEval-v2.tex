...
\usepackage[T5,T1]{fontenc}   % T5 = Vietnamese, T1 = default (last listed)
\usepackage{vntex}             % Vietnamese glyph support (Lê, Vĩnh, Tỷ, Hữu, Khương, ...)
\usepackage{times}
...
\lhead{\small FPT University --- FSB --- MSE-AI}
\cfoot{\thepage}
...
% ===== VIETNAMESE LABELS (auto-generated LaTeX strings) =====
...
{\large FPT School of Business and Technology (FSB)}\\[0.3cm]
{\normalsize Master of Software Engineering --- Artificial Intelligence}\\[1.8cm]
...
{\normalsize Course: Methods of Learning and Scientific Research}\\[1.4cm]

{\normalsize\textbf{Research Team}}\\[0.3cm]
\begin{tabular}{ll}
Lê Lâm Vĩnh          & 25MS23328 \\
Hoàng Phi Hải        & 25MS23323 \\
Đỗ Hoàng Tỷ Phú      & 25MS23327 \\
Trịnh Hữu Tuấn       & 25MS23315 \\
Trần Quang Tuấn      & 25MS23331 \\
\end{tabular}\\[1.0cm]

\begin{tabular}{ll}
\textbf{Supervisor:} & Assoc. Prof. Dr. Hồ Văn Khương \\
                     & \small\textit{Faculty of Electrical and Electronics Engineering,} \\
                     & \small\textit{Ho Chi Minh City University of Technology (HCMUT)} \\
